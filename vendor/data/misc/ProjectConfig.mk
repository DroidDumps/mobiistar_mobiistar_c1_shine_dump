...
BUILD_UBOOT = no
CUSTOM_BUILD_VERNO =
export VSUN_SW_VER = Mobiistar_C1_Shine_IN_V1.12_12012018
export VSUN_SW_VER_INNER = Mobiistar_C1_Shine_IN_V1.12_12012018
...
CUSTOM_HAL_IMGSENSOR =s5k4h7txdyx_mipi_raw s5k4h7yx_mipi_raw s5k3l8_mipi_raw s5k4h7yx_sub_mipi_raw s5k4h7yxtxd_sub_mipi_raw
...
CUSTOM_HAL_MAIN_IMGSENSOR = s5k3l8_mipi_raw s5k4h7txdyx_mipi_raw s5k4h7yx_mipi_raw
CUSTOM_HAL_MAIN_LENS = dw9714af
CUSTOM_HAL_MSENSORLIB =akl
CUSTOM_HAL_SENSORS = sensor
CUSTOM_HAL_SUB_BACKUP_IMGSENSOR =
CUSTOM_HAL_SUB_BACKUP_LENS = ad5820af
CUSTOM_HAL_SUB_IMGSENSOR = s5k4h7yx_sub_mipi_raw s5k4h7yxtxd_sub_mipi_raw
...
CUSTOM_KERNEL_IMGSENSOR =s5k4h7txdyx_mipi_raw s5k4h7yx_mipi_raw s5k3l8_mipi_raw s5k4h7yx_sub_mipi_raw s5k4h7yxtxd_sub_mipi_raw
...
CUSTOM_KERNEL_MAIN_IMGSENSOR = s5k3l8_mipi_raw s5k4h7txdyx_mipi_raw s5k4h7yx_mipi_raw
...
CUSTOM_KERNEL_SUB_IMGSENSOR = s5k4h7yx_sub_mipi_raw s5k4h7yxtxd_sub_mipi_raw
...
CUSTOM_MODEM = L5391B_G2_W18_LTE13540_V159
...
#begin, vsun liyong for arc algrithm
VSUN_ARC_CAM_ALG = yes
VSUN_ARC_ALG32 = yes
VSUN_ARC_MT_PLATFORM = 6739t
#end, vsun liyong for arc algrithm
#begin, vsun for front cam flip
VSUN_FRONT_CAM_SHOT_FLIP = yes
#end, vsun for front cam flip
ROCK_GOTA_SUPPORT := yes

CELL_BROADCAST_SUPPORT := no
MTK_NN_SDK_SUPPORT = no
MTK_REDBEND_DM_CLIENT_SUPPORT = no

#add for Airtel Volte £ºMO USSD not working(fall back to 3G)
MTK_USSI_SUPPORT = yes
#end for Airtel Volte £ºMO USSD not working(fall back to 3G)
#FACE_UNLOCK_SUPPORT start
FACE_UNLOCK_SUPPORT = true
FACE_UNLOCK_WITH_ICON = false
